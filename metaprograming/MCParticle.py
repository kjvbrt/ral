...
def write_mcparticle_code(header_dir: str, src_dir: str):
    ...
    writer.add_printer("p_end", "float", Edm4hepCollection.RVEC, "momentum")
    writer.add_printer("pt_end", "float", Edm4hepCollection.RVEC, "transverse momentum")
    writer.add_printer("px_end", "float", Edm4hepCollection.RVEC, "x momentum")
    writer.add_printer("py_end", "float", Edm4hepCollection.RVEC, "y momentum")
    writer.add_printer("pz_end", "float", Edm4hepCollection.RVEC, "z momentum")
    writer.add_printer("eta_end", "float", Edm4hepCollection.RVEC, "pseudorapidity")
    writer.add_printer("rapidity_end", "float", Edm4hepCollection.RVEC, "rapidity")
    writer.add_printer("theta_end", "float", Edm4hepCollection.RVEC, "polar angle")
    writer.add_printer("phi_end", "float", Edm4hepCollection.RVEC, "azimutal angle")
    ...
    writer.add_printer("r_end", "float", Edm4hepCollection.RVEC, "distance to origin")
    writer.add_printer("x_end", "float", Edm4hepCollection.RVEC, "x coordinate")
    writer.add_printer("y_end", "float", Edm4hepCollection.RVEC, "y coordinate")
    writer.add_printer("z_end", "float", Edm4hepCollection.RVEC, "z coordinate")
    writer.add_printer("e", "float", Edm4hepCollection.RVEC, "energy")
    writer.add_printer("e_end", "float", Edm4hepCollection.RVEC, "energy")
    ...
    writer.add_printer("sim_stat", "int", Edm4hepCollection.RVEC, "simulator status")
    writer.add_printer("gen_stat", "int", Edm4hepCollection.RVEC, "generator status")
